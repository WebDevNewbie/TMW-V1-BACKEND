...
class Ajax_pagination{
	...
	var $first_link   		= '';
	var $next_link			= '<button type="button" class="btn btn-success"><i class="glyphicon glyphicon-chevron-right"></i></button>';
	var $prev_link			= '<button type="button" class="btn btn-success"><i class="glyphicon glyphicon-chevron-left"></i></button>';
	var $last_link			= '';
	var $uri_segment		= 3;
