                  ...
                  <div class="modal-body">
                      <div class="row">
                        <div class="col-sm-6 col-md-6">
                          <form action="<?php echo base_url().'dashboard/drop_item/'.$row->id; ?>" method="post">
                            <input type="hidden" value="<?php echo $row->filename; ?>" name="filename">
                            <input type="hidden" value="<?php echo $row->category_id; ?>" name="cat_id">
                            <button type="submit" id="menutab" class="btn btn-lg btn-block btn-success">Yes</button> 
                          </form>
                        </div>
                        <div class="col-sm-6 col-md-6">
                          <a type="submit" data-dismiss="modal" id="menutab" class="btn btn-lg btn-block btn-primary">No</a> 
                        </div>
                      </div>
                  </div>
                </div>
