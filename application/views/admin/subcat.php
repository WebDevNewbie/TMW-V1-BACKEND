    ...
    <div class="panel-body " style="overflow-y:scroll;height:100%; padding-bottom:170px">
      <?php foreach ($category as $row) :?>
      	<div class="col-md-4 col-sm-6 col-xs-12">
      		<a href="<?php echo base_url().'dashboard/sub_category/'.$row->id.'a'.$this->uri->segment(3) ; ?>" class="thumbnail" style="text-decoration:none;">
      			<img src="<?php if($row->path === 0 || $row->path === NULL || $row->path === ''){ echo base_url().'category_img/food.jpeg'; }else{ echo base_url().$row->path.$row->filename; } ?>" class="img-responsive" alt="Cinque Terre" style="height:180px;width:100%;"> 
      			<div id="opah">	
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form enctype="multipart/form-data"  action="<?php echo base_url().'dashboard/add_item/' ;?>" id="registerNewitem" method="post" class="form-group">
          <input type="text" value="<?php echo $cat_id; ?> " name="cat_id">
          <div class="modal-body">
            <div class="form-group">
              <p>Item Name</p>
                <div class="input-group">
                  <div class="input-group-addon"><span class="glyphicon glyphicon-list"></span></div>
                  <input type="text" class="form-control field" placeholder="Item Name" name="item_name">
                </div>
            </div>
            <div class="form-group">
              <p>Description</p>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control field" placeholder="Description" name="description">
                </div>
            </div>
            <div class="form-group">
              <p>Price</p>
                <div class="input-group">
                  <div class="input-group-addon"><span class="glyphicon glyphicon-share-alt"></span></div>
                  <input type="decimal" class="form-control field" placeholder="Price" name="price">
                </div>
            </div>
            <div class="form-group">
              <p>item Image</p>
