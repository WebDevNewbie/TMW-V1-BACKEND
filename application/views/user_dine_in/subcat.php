			<ol class="breadcrumb" style="position:fixed;width:100%">
			  <li><a href="<?php echo base_url().'kiosk_dine_in';?>">Menu Category</a></li>
				    		...
				    		<?php if(count($category) > 0) { ?>
				    			<?php foreach ($category as $row) :?>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 kiosk_dine_in">
										<a href="<?php echo base_url().'kiosk_dine_in/select_item/'.$row->id.'a'.$this->uri->segment(3); ?>" class="thumbnail"  style="text-decoration:none;">
