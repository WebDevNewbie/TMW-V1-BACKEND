		...
		<div class="row">
						...
						<?php endif; ?>
			  			...
			  			<div class="panel-body" >
							...
							<?php if (count($order_data) != 0) : ?>
								...
								<form action="<?php echo base_url().'kiosk_dine_in/order'; ?>" method="post">
			...
			<div class="col-md-7 col-sm-7" >
				<div class="panel panel-success" style="height:100%;position:fixed;margin-right:10px;margin-top:10px">
					<div class="panel-heading">
						<!-- <h3 style="color:white">Take Away Orders</h3> -->
						<div class="row">
							<div class="col-md-6 col-sm-6" id="tbl_num" >
								<div class="input-group" >
					      			...
					      			<?php 
					      				...
					      				$res = @$table_no->result();
					      			?>
					      			<select class="form-control input-lg" onchange="table_num(this.value)">
						    				<option >Select</option>
					      				<?php for($x = 1 ; $x <= $res[0]->table_no ; $x++){ ?>
							...
							<div class="form-group">
									<h5 style="color:white;font-size:20px;font-weight: bold;">Dine In Orders</h5>
									<!-- <button type="button" value="1" class="btn btn-default btn-block" id="toggleMenu" style="border-left:10px solid #777;">Dine In</button> -->
								</div>
		  			...
		  			<div class="panel-body"  style="overflow-y:auto;height:100%; padding-bottom:230px">
		    			<?php foreach ($category as $row) :?>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 kiosk_dine_in">
								<a href="<?php echo base_url().'kiosk_dine_in/select_category/'.$row->id; ?>" class="thumbnail"  style="text-decoration:none;">
