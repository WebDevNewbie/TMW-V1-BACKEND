...
<body >
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<?php //if($this->uri->segment(2) === 'sub_category') { ?>
						<!-- <li><a href="<?php echo base_url().'discount/discount_item/'.$this->uri->segment(3);?>" ><img src="<?php echo base_url();?>/img/paymenttab.png" class="img-responsive"/>Discount</a></li> -->
					<?php //} ?>
		                ...
		                <div class="modal-body">
		                  	...
		                  	<div class="form-group">
		                      	<div class="input-group">
		                        	...
		                        	<input type="number" value="<?php echo $table_no[0]->table_no; ?>" class="form-control input-lg field" placeholder="" name="table_no" >
		                ...
		                <div class="modal-body">
		                  	<div class="form-group">
		                    	<p>No. of Tables</p>
		                      	<div class="input-group">
		                        	<div class="input-group-addon"><span class="glyphicon glyphicon-list"></span></div>
		                        	<input type="number" value="" class="form-control input-lg field" placeholder="" name="table_no" >
		                      	</div>
		                  	</div>
	...
	<div id="mainboard-wrapper">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12" id="divlist">
					<div class="row">
						<div class="col-md-12">
