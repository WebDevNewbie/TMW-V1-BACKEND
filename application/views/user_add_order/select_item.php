			...
			<ol class="breadcrumb" style="position:fixed;width:100%">
			  	<li><a href="<?php echo base_url().'add_order/index/'.$rcpt_id['rcpt_id'];?>">Menu Category</a></li>
									...
									<?php if(count($category) > 0) { ?>
										<div class="row">
												<div class=" addAll" style="margin-right:50px;margin-top:10px;float:right;">
													<form action="<?php echo base_url().'add_order/order_items1' ; ?>" method="post">
							...
							<?php if(count($category) > 0) { ?>
				    			<?php foreach ($category as $row) : ?>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 itemSelect">
											...
											<form action="<?php echo base_url().'add_order/order_items' ;?>" method="post">
